        ...
        <div className="card glass" style={{
          ...
          <div style={{marginBottom: '1.5rem'}}>
            <div className="flex justify-between" style={{fontSize: '0.8rem', marginBottom: '0.4rem'}}>
              ...
              <span style={{color: '#fbbf24', fontWeight: 700}}>{completedStations.length}/{stations.length} {t('passport_page.stations')}</span>
            </div>
              ...
              return (
                <div key={station.id} onClick={() => toggleStation(station.id)} className="animate-fade-in"
                  style={{
                    ...
                    padding: '0.8rem 0.5rem', borderRadius: '12px',
                  ...
                  {isDone && (
                    <div style={{position: 'absolute', top: '-4px', right: '-4px', background: '#22c55e', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', color: 'white', fontWeight: 900, boxShadow: '0 2px 6px rgba(34,197,94,0.5)'}}>✓</div>
                  )}
                </div>
              );
            })}
